...
public class BinarySearchDemo {
	...
	public static void main (String[] args){
		...
		{		
			...
			BinarySearchTreeR<String> testTree = new BinarySearchTreeR<String>();
			...
			//part 4 which removes two entries from the tree and perform in order traversal
			testTree.remove("Latvia");
			testTree.remove("France");
			System.out.println("\nIn-order traversal of the test tree part 4");
			testTree.inorderTraverse();
			System.out.println("\nSome statistics about the test tree part 4");
			displayStats(testTree);
