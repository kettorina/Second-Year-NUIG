		...
		public static void main(String[] args ){
			...
			for(int i=0;i<=3;i++)
			{
				...
				for(int j=0;j<=4;j++){
					...
					AverageTimeSorted[j]=(int) quickdifference;
				...
				double MoveReversed = CalculateAverage(AverageMoveReversed);
				double CompReversed = CalculateAverage(AverageCompReversed);
				double TimeReversed = CalculateAverage(AverageTimeReversed);
				...
				System.out.println("reversed average" + "\t" + CreateSize(i) +"\t" + TimeReversed +
						"\t"+ MoveReversed + "\t" + CompReversed);
			}
	}
