...
//		BinaryTree<String> testTree = MMExtra.createRecursiveTree(3);
	...
	public static BinaryTree<String> createTree2(int height){
		...
		System.out.println("Height: " + height + "\tNumber: " +str);
		if(height<=1){
			leaf = new BinaryTree<String>(str,null,null);
		}
		else{
			leaf = new BinaryTree<String>(str,createTree2(height-1),createTree2(height-1));
		}
		return leaf;
	}
